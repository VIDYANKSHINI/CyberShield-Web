...
export default function Navbar() {
  ...
  const dropdownItems = ["About", "Sustainability", "Careers", "GenCell Ltd."];
            ...
            {navItems.map((item) => (
              ...
              >
                <a
                  ...
                  className={`text-[17px] font-nav-items tracking-wide text-white transition-opacity duration-300 ${
